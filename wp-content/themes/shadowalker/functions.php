...
add_action('wp_enqueue_scripts', function () {
    wp_enqueue_style('shadowalker', get_template_directory_uri() . '/assets/css/store.css', [], '1.2.0');
    wp_enqueue_style('shadowalker-tech', get_template_directory_uri() . '/assets/css/tech.css', ['shadowalker'], '1.2.0');
