...
WP_CLI::add_command('shadowalker seed', function () {
    ...
    $pages = [
        'home' => ['Home', ''],
        'contact' => ['Let’s find your next way to move.', '<p>Tell us about your destination, product needs and quantity. For conversion kits, include your wheel size, frame type and battery requirements.</p>[shadowalker_inquiry]'],
