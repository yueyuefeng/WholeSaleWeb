...
<div class="announcement"><span class="system-dot" aria-hidden="true"></span>SHADOWALKER / ELECTRIC MOBILITY<span><?php esc_html_e('Go your own way.', 'shadowalker'); ?> ↗</span></div>
<header class="site-header"><div class="header-inner">
<a class="brand" href="<?php echo esc_url(home_url('/')); ?>" aria-label="Shadowalker home"><span class="brand-mark" aria-hidden="true">S<span>∕</span></span>SHADOWALKER<span class="brand-dot">↗</span></a>
